[![Build Status](https://travis-ci.org/OCA/hr-timesheet.svg?branch=10.0)](https://travis-ci.org/OCA/hr-timesheet)
...
[hr_timesheet_task](hr_timesheet_task/) | 10.0.1.0.2 | Allow the user to select task in a timesheet
