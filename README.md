...
[crm_timesheet](crm_timesheet/) | 12.0.2.1.0 |  | CRM Timesheet
[hr_employee_product](hr_employee_product/) | 12.0.1.0.0 |  | Product is an employee
[hr_timesheet_activity_begin_end](hr_timesheet_activity_begin_end/) | 12.0.1.1.1 |  | Timesheet Activities - Begin/End Hours
...
[hr_timesheet_employee_required](hr_timesheet_employee_required/) | 12.0.1.1.0 |  | Require Employee for any Time Log entry
[hr_timesheet_nonpayable](hr_timesheet_nonpayable/) | 12.0.1.0.0 |  | Mark timesheet entries as non-payable to exclude from costs.
[hr_timesheet_portal](hr_timesheet_portal/) | 12.0.1.0.0 |  | Fill in timesheets via the portal
[hr_timesheet_report](hr_timesheet_report/) | 12.0.1.0.0 | [![alexey-pelykh](https://github.com/alexey-pelykh.png?size=30px)](https://github.com/alexey-pelykh) | Generate Timesheet Report from Task Logs
[hr_timesheet_role](hr_timesheet_role/) | 12.0.2.0.0 |  | Track time on project according to the role assigned
[hr_timesheet_sheet](hr_timesheet_sheet/) | 12.0.3.7.4 |  | Timesheet Sheets, Activities
...
[hr_timesheet_sheet_attendance](hr_timesheet_sheet_attendance/) | 12.0.1.0.1 |  | HR Timesheet Sheet Attendance
...
[hr_timesheet_sheet_policy_department_manager](hr_timesheet_sheet_policy_department_manager/) | 12.0.1.1.0 |  | Allows setting Department Manager as Reviewer
[hr_timesheet_sheet_policy_direct_manager](hr_timesheet_sheet_policy_direct_manager/) | 12.0.1.2.0 |  | Allows setting Direct Manager as Reviewer
[hr_timesheet_sheet_policy_project_manager](hr_timesheet_sheet_policy_project_manager/) | 12.0.1.1.0 |  | Allows setting Project Manager as Reviewer
[hr_timesheet_sheet_role](hr_timesheet_sheet_role/) | 12.0.2.2.0 |  | Track time on project according to the role assigned via My Timesheet Sheets
[hr_timesheet_task_domain](hr_timesheet_task_domain/) | 12.0.1.0.0 |  | Limit task selection to tasks on currently-selected project
[hr_timesheet_task_required](hr_timesheet_task_required/) | 12.0.1.0.4 |  | Set task on timesheet as a mandatory field
[hr_timesheet_task_stage](hr_timesheet_task_stage/) | 12.0.1.1.0 |  | Open/Close task from corresponding Task Log entry
[hr_timesheet_time_type](hr_timesheet_time_type/) | 12.0.1.0.0 |  | Ability to add time type in timesheet lines.
...
[hr_utilization_report](hr_utilization_report/) | 12.0.1.0.2 |  | Generate Utilization Report from Task Logs
...
[sale_timesheet_limit_date](sale_timesheet_limit_date/) | 12.0.1.0.1 |  | Layouts
...
[sale_timesheet_purchase](sale_timesheet_purchase/) | 12.0.1.0.0 |  | Bridge module between Sales Timesheet and Purchase
