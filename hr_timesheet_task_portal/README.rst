...
========================
HR Timesheet Task Portal
========================

This module will make it possible for portal users with access to a
project to display timesheet entries that users have made to a task.
...
hr_timesheet_task_portal%0Aversion:%20
