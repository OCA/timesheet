...
class TestHrTimesheetSheet(HrTimesheetTestCases):
    ...
    def test_01_compute_total_time_and_difference(self):
        ...
        # Attendance - 1
        checkInDate = datetime.datetime(2022, 2, 12, 10, 0, 0)
        checkOutDate = datetime.datetime(2022, 2, 12, 12, 0, 0)
        self._create_attendance(
            employee=self.employee,
            checkIn=checkInDate,
        ...
        # Attendance - 2
        checkInDate = datetime.datetime(2022, 2, 12, 13, 0, 0)
        checkOutDate = datetime.datetime(2022, 2, 12, 14, 0, 0)
        self._create_attendance(
            employee=self.employee,
            checkIn=checkInDate,
            checkOut=checkOutDate,
        ...
        # # Attendance - 3
        checkInDate = datetime.datetime(2022, 2, 12, 16, 0, 0)
        ...
        attendance_3.check_out = datetime.datetime(2022, 2, 12, 17, 0, 0)
        self.timesheet.action_timesheet_confirm()
        self.assertEqual(
